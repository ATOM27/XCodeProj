...
-(EMUsers*) addUserWithName:(NSString*)name lastName:(NSString*)lastName email:(NSString*)email{
    ...
    EMUsers* user = [NSEntityDescription insertNewObjectForEntityForName:@"EMUsers" inManagedObjectContext:[[[EMDataManager sharedManager] persistentContainer] viewContext]];
...
- (NSPersistentContainer *)persistentContainer {
    ...
    @synchronized (self) {
        if (_persistentContainer == nil) {
            _persistentContainer = [[NSPersistentContainer alloc] initWithName:@"ObjCCoreDataDZ"];
